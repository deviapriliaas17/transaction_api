...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Exception $exception)
    {
       ...
       if($exception instanceof ModelNotFoundException){
          ...
          return $this->errorResponse("Does not exists any $modelName with the specific field",400);
       }
       ...
       if($exception instanceof QueryException){
           ...
           if($errorCode == 1451){
               $message = 'Cannot remove this resource permanently. It is related with any resources';
               $code    = 409;
